        ...
        <Grid className="contact-grid">
          <Cell col={6}>
            ...
            <img
              ...
              style={{height: '250px'}}
               />
             <p style={{ width: '75%', margin: 'auto', paddingTop: '1em'}}>Enthusiastic, highly-motivated Computer science and engineering student with
